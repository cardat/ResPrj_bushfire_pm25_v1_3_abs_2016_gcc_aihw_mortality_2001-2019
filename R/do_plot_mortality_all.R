...
# Create the plot for the whole sample (obs)
plot(all_sum_gccs_dly ~ doy, obs, pch = 19, col = grey(0.8), cex = 0.5,
     ylab = "Daily deaths", xlab = "Day of the year", main = "Observed Mortality all GCCs (2001-2019)")

# Add a line plot for the whole sample
lines(1:366, tapply(obs$all_sum_gccs_dly, obs$doy, mean), lwd = 1.5, col = 4)
